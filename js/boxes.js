...
crateSmash = new Audio("../audio/boxes/smash.wav"); // Crate bump
bg = new Audio("../audio/menuclick.wav"); // Background music
bgEffect = new Audio("../audio/menuclick.wav"); // Background creaks
menuclick = new Audio("../audio/menuclick.wav"); // Arrow click sound effect
slide = new Audio("../audio/menuclick.wav"); // Transition sound
...
function startScene() {
    ...
    // Grass
    grassTexture = THREE.ImageUtils.loadTexture("../assets/boxes/cartoon_grass.jpg");
    ...
    // Forest
    forestFrontTexture = THREE.ImageUtils.loadTexture("../assets/boxes/forestPanelFront.png");
    ...
    // Forest Mid
    forestMidTexture = THREE.ImageUtils.loadTexture("../assets/boxes/forestPanelMid.png");
    ...
    // Particles
    particleTexture = THREE.ImageUtils.loadTexture("../assets/boxes/particleTexture.png");

    // Crate textures
    // crateTexture = THREE.ImageUtils.loadTexture("../assets/boxes/create4texture.png");
    crateTexture = THREE.ImageUtils.loadTexture("../assets/boxes/steel_box.png");
    crateTexture2 = THREE.ImageUtils.loadTexture("../assets/boxes/crate2.png");
    crateTexture3 = THREE.ImageUtils.loadTexture("../assets/boxes/crate5.jpg");
    crateTexture4 = THREE.ImageUtils.loadTexture("../assets/boxes/crate3.jpg");
...
// ## User interaction
scroll_able = true;
function go_to_back_box() {
    if (can_click == 1 && position > 0) {
        moveCamera(crateOffset); // Move the camera
        position--; // Decrease our position in the slider
        crateInfo(position); // Update crate info
        scroll_able = true
        console.log(crates.length - 1, position);
    }
}
function go_to_next_box() {
    if (can_click == 1 && position < crates.length - 1) {
